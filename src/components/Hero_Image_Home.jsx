    ...
    return (
        <>
            <Card>
                ...
                <Card.Img variant="top" src="https://d2lljesbicak00.cloudfront.net/merida-v2/media-content-img-big//global/2022/product-news-updates/big-trail-my2022/22-product-news-bigtrail-my2022-product-sideview.jpg?p3" style={{ width: '1100px', height: '800px', margin: 'auto', display: 'block' }} />
                <Card.Body>
