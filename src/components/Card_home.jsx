    ...
    return (
        <>
            <Card>
                ...
                >
                    <h2>Introducing Big Trail</h2>
                </div>
                <Card.Img variant="top" src="https://d2lljesbicak00.cloudfront.net/merida-v2/media-content-img-big//global/2022/product-news-updates/big-trail-my2022/22-product-news-bigtrail-my2022-product-sideview.jpg?p3" />
                <Card.Body>
                    <Card.Text>
